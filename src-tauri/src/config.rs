...
pub fn get_app_config_dir() -> PathBuf {
    ...
    // Never auto-adopt ~/.cc-switch. It belongs to a different product and
    // sharing it recreates the cross-application corruption Chimera++ avoids.
    get_home_dir().join(crate::product_policy::PRODUCT_DATA_DIR)
}
