...
export const EN_PLAIN: Record<string, string> = {
  ...
  "运行状态": "Runtime status",
  "配置保存在 Chimera++，实时操作通过本机回环 CDP 执行": "Configuration stays in Chimera++; live operations use the local loopback CDP connection",
  ...
  "自定义图片会被导入 Chimera++ 托管目录；主题字段与目标项目 theme.json 对齐":
    "Custom images are imported into Chimera++ managed storage; theme fields match the source theme.json.",
  "我的主题": "My themes",
  ...
  "Chimera++ 主入口": "Chimera++ primary entrypoint",
  ...
  "编辑扩展项": "Edit entry",
  "缺失": "Missing",
  "缺少 Chimera++ 主快捷方式时可在安装维护页修复。": "When the Chimera++ primary shortcut is missing, repair it on the Install & Maintenance page.",
...
export const EN_TEMPLATE: Record<string, string> = {
  ...
  "检测到代理环境变量：{0}。请清理后重新启动 Chimera++。":
    "Proxy environment variables detected: {0}. Remove them and restart Chimera++.",
