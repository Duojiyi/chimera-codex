...
pub enum ZedRemoteError {
    ...
    #[error("Cannot read Chimera++ Zed remote project registry")]
    RegistryRead(#[source] std::io::Error),
    #[error("Cannot parse Chimera++ Zed remote project registry")]
    RegistryParse(#[source] serde_json::Error),
    #[error("Cannot write Chimera++ Zed remote project registry")]
