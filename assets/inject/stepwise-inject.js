(() => {
  ...
  function toggleCodexTheme() {
    ...
    setCodexThemeMode(nextTheme)
      ...
      .catch((error) => {
        console.warn("[Chimera++ Stepwise] Failed to switch Codex theme", error);
      });
  }
  ...
  function statusLine(settings) {
    if (settings.enabled !== true) return "Stepwise 已关闭，请在 Chimera++ 管理工具里开启。";
  ...
  async function openManager() {
    state.settingsStatus = "正在打开 Chimera++ 管理工具...";
    renderFloat();
