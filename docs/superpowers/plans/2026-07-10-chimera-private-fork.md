...
- [ ] **Step 1: Add a complete ChimeraHub preset**
...
- [ ] **Step 2: Remove promo presets**

删除 `jojocode`、`jojocode-max`；删除 `siliconflow` 等预设中的邀请码，若有无推广的官方入口则替换为官方入口。

- [ ] **Step 3: Add first-run settings constructor**
...
- [ ] **Step 4: Add atomic save-and-enable command**
...
git commit -m "feat: add safe first-run ChimeraHub setup"
```
